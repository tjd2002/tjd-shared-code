function [result, wf] = writeNexFile(nexFile, fileName)
...
%           it is recommened that you read a valid .nex file to fill this
%           structure, then, modify the structure and save it
